...
\centering
\includegraphics[width=\linewidth, height=2.2cm, keepaspectratio]{images/ministere.png}
\end{minipage}
\hfill
...
\begin{center}
\textit{\textbf{À mon frère Mohamed et mes sœurs Arij, Rana}}
...
\vspace{0.3cm}
\label{fig:dashboard}
\includegraphics[width=0.9\textwidth]{images/dash.png}\vspace{3cm}
\end{figure}
...
\label{fig:users}
\vspace{3cm}
\includegraphics[width=0.9\textwidth]{images/gestiondesusers.png}\vspace{3cm}
\end{figure}
...
\vspace{3cm}
\includegraphics[width=0.9\textwidth]{images/listenoire.png}\vspace{3cm}
...
\label{fig:imei}
\vspace{3cm}
\includegraphics[width=0.9\textwidth]{images/imei.png}\vspace{3cm}
\end{figure}
...
\label{fig:testfresh}
\vspace{3cm}
\includegraphics[width=0.9\textwidth]{images/freshtrain.png}\vspace{3cm}
\end{figure}
...
\vspace{3cm}
\includegraphics[width=0.9\textwidth]{images/authentificationpage.png}\vspace{3cm}
\end{figure}
...
\vspace{3cm}
\includegraphics[width=0.9\textwidth]{images/vrf.png}\vspace{3cm}
\end{figure}
...
% ============================================================
\newpage % Force le passage à la page suivante pour le résumé
\thispagestyle{empty}

\begin{center}
    \textbf{DÉTECTION DE FRAUDE SIM BOX PAR MACHINE LEARNING}\\[0.5em]
    \rule{8cm}{2pt}\\[0.5em]
    \textbf{Samar GUIZANI}\\
    \rule{8cm}{2pt}
\end{center}
...
\vspace{0.8cm}
\textbf{Mots clés :} fraude SIM Box, télécommunications, Machine Learning, XGBoost, Big Data, Flask, PostgreSQL.

\vspace{1.5cm} % Espace entre le français et l'anglais
